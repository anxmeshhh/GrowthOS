  ...
  return (
    <div className="min-h-screen bg-[#080808] text-[#f0f0f0]">
      <div className="max-w-5xl mx-auto px-6 py-14">
        ...
        {/* Header */}
        <div className="mb-12">
          <p className="text-[11px] font-semibold tracking-[0.14em] uppercase text-[#22c55e] mb-3">
            Discover
          </p>
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-10">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full bg-[#0e0e0e] border border-[#1e1e1e] rounded-[10px] py-2.5 pl-9 pr-4 text-[13px] text-[#f0f0f0] placeholder-[#444] focus:outline-none focus:border-[#2e2e2e] transition-colors"
            />
          </div>
          <Link to="/paths/create">
            <button className="flex items-center gap-2 bg-transparent border border-[#222] hover:border-[#333] hover:bg-[#111] rounded-[10px] px-4 py-2.5 text-[13px] font-medium text-[#aaa] hover:text-[#f0f0f0] transition-all whitespace-nowrap">
              <Plus size={14} />
              Create Path
            </button>
          </Link>
    ...
    <div className="group bg-[#0e0e0e] border border-[#1a1a1a] hover:border-[#252525] hover:bg-[#111] rounded-2xl p-6 flex flex-col gap-5 transition-all duration-200">
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <h3 className="text-[15px] font-semibold text-[#f0f0f0] leading-snug truncate">
            {path.title}
          </h3>
      ...
      {/* Description */}
      <p className="text-[13px] text-[#4a4a4a] leading-[1.7] flex-1">
      ...
      {topicCount > 0 && (
        <div className="flex flex-col gap-2">
          <div className="flex justify-between items-center">
            ...
            <span
              className={`text-[11px] font-semibold font-mono ${isCustom ? "text-[#a78bfa]" : "text-[#22c55e]"
                }`}
            >
              {progress} / {topicCount}
            </span>
      ...
      <div className="border-t border-[#141414] pt-4">
        <Link to="/roadmap" search={{ pathId: path.id }} className="block">
          <button className="w-full bg-[#141414] hover:bg-[#1a1a1a] border border-[#1e1e1e] hover:border-[#2a2a2a] rounded-[9px] py-2.5 text-[13px] font-medium text-[#bbb] hover:text-[#f0f0f0] transition-all">
            View Roadmap
          </button>
        </Link>
      </div>
