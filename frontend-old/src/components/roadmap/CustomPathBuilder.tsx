...
function DarkTextarea({
  ...
  return (
    <textarea
      ...
      onFocus={(e) => {
        (e.target as HTMLElement).style.borderColor = "#2a3a2a";
      }}
      onBlur={(e) => {
...
function KindPicker({ value, onChange }: { value: NodeKind; onChange: (k: NodeKind) => void }) {
  ...
  return (
    <div className="relative">
      ...
      {open && (
        ...
        >
          {(Object.entries(KIND_META) as [NodeKind, (typeof KIND_META)[NodeKind]][]).map(
            ([k, m]) => {
              const KIcon = m.icon;
              return (
                <button
                  ...
                  onMouseLeave={(e) => {
                    (e.currentTarget as HTMLElement).style.background =
                      k === value ? m.bg : "transparent";
                  }}
                >
                  <KIcon size={11} />
                  <div>
                    <div className="text-sm font-mono">{m.label}</div>
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 px-3 py-2">
        ...
        <span className="text-sm font-mono w-5 text-center shrink-0" style={{ color: meta.dot }}>
          {index + 1}
        </span>
        ...
        <button
          ...
          onMouseLeave={(e) => {
            (e.currentTarget as HTMLElement).style.color = "#3a1a1a";
          }}
        >
          <X size={12} />
        </button>
    ...
    >
      ...
      >
        ...
        >
          ...
          <DialogDescription className="text-sm mt-0.5" style={{ color: "#3a5a3a" }}>
        ...
        <div
          ...
          style={{ scrollbarWidth: "thin", scrollbarColor: "#1e3a1e #080c08" }}
        >
          {/* Error / success */}
          {error && (
            <div
          ...
          >
            ...
            <div className="flex gap-2">
              <input
                ...
                onFocus={(e) => {
                  (e.target as HTMLElement).style.borderColor = "#3b5bdb";
                }}
                onBlur={(e) => {
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3">
              <label
                className="text-sm font-mono uppercase tracking-wider shrink-0"
                style={{ color: "#3a5a3a" }}
              >
                Duration
              </label>
            ...
            <div className="flex items-center gap-3 pt-2">
              <div className="flex items-center gap-2">
                ...
                <label
                  htmlFor="syncGitHub"
                  className="text-sm font-mono text-[#a8c078] cursor-pointer flex items-center gap-2"
                >
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              >
                Topics
                {topics.length > 0 && (
                  <span className="ml-2 font-mono" style={{ color: "#2a3a2a" }}>
                    ({topics.filter((t) => t.title.trim()).length} valid)
                  </span>
                )}
              </span>
            ...
            {topics.length === 0 ? (
              ...
              >
                <p className="text-lg font-mono" style={{ color: "#2a3a2a" }}>
                  No topics yet
                </p>
                <p className="text-sm mt-1" style={{ color: "#1a2a1a" }}>
                ...
                ([k, m]) => {
                  ...
                  return (
                    <div key={k} className="flex items-center gap-1">
                      ...
                      <span className="text-xs font-mono" style={{ color: "#2a3a2a" }}>
                        {m.label}
                      </span>
                    </div>
                  );
